...
void APsyonicCharacterBase::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &APsyonicCharacterBase::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &APsyonicCharacterBase::Look);
	}

}

void APsyonicCharacterBase::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void APsyonicCharacterBase::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
